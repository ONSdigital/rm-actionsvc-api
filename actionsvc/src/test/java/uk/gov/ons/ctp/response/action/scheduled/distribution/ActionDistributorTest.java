...
//  /**
//   * Test that when we momentarily fail to call CaseSvc to GET two cases we carry on trying and successfully deal with
//   * the actions/cases we can retrieve.
//   *
//   * @throws Exception oops
//   */
//  @Test
...
//    List<Action> actionsHHIC = FixtureHelper.loadClassFixtures(Action[].class, HOUSEHOLD_INITIAL_CONTRACT);
//    List<Action> actionsHHIACLOAD = FixtureHelper.loadClassFixtures(Action[].class, HOUSEHOLD_UPLOAD_IAC);
//
...
//
//    // wire up mock responses in the sequence that they are called
//    Mockito.when(actionTypeRepo.findAll()).thenReturn(actionTypes);
//
//    Mockito
//        .when(actionRepo.findByActionTypeNameAndStateInAndActionPKNotIn(eq(HOUSEHOLD_INITIAL_CONTRACT),
//            anyListOf(ActionState.class),
//            anyListOf(BigInteger.class), any(Pageable.class)))
//        .thenReturn(actionsHHIC);
//    Mockito.when(
//        actionRepo.findByActionTypeNameAndStateInAndActionPKNotIn(eq(HOUSEHOLD_UPLOAD_IAC),
//            anyListOf(ActionState.class),
//            anyListOf(BigInteger.class), any(Pageable.class)))
...
//    verify(actionTypeRepo).findAll();
//
//    verify(actionRepo).findByActionTypeNameAndStateInAndActionPKNotIn(eq(HOUSEHOLD_INITIAL_CONTRACT),
//        anyListOf(ActionState.class), anyListOf(BigInteger.class),
//        any(Pageable.class));
//    verify(actionRepo).findByActionTypeNameAndStateInAndActionPKNotIn(eq(HOUSEHOLD_UPLOAD_IAC),
//        anyListOf(ActionState.class), anyListOf(BigInteger.class),
//        any(Pageable.class));
//
//    verify(caseSvcClientService, times(2))
//        .getCaseWithIACandCaseEvents(eq(CASE_ID_ABORTED_INITIAL));
//    verify(caseSvcClientService, times(2))
...
////    Mockito.when(
////        caseSvcClientService.getCaseWithIACandCaseEvents(eq(CASE_ID_ABORTED_INITIAL)))
////        .thenReturn(caseDTOs.get(0));
////
////    Mockito.when(
////        caseSvcClientService.createNewCaseEvent(any(Action.class), eq(CategoryDTO.CategoryName.ACTION_CREATED)))
...
//    verify(actionTypeRepo).findAll();
//    verify(actionRepo, times(1)).findByActionTypeNameAndStateInAndActionPKNotIn(
//        eq(HOUSEHOLD_INITIAL_CONTRACT),
//        anyListOf(ActionState.class), anyListOf(BigInteger.class), any(Pageable.class));
//    verify(actionRepo, times(1)).findByActionTypeNameAndStateInAndActionPKNotIn(
//        eq(HOUSEHOLD_UPLOAD_IAC),
//        anyListOf(ActionState.class), anyListOf(BigInteger.class), any(Pageable.class));
//
