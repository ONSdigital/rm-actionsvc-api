...
public class ActionDTO {
  ...
  public enum ActionEvent {
    ...
    REQUEST_COMPLETED_DEACTIVATE, REQUEST_COMPLETED_DISABLE, REQUEST_CANCELLED, CANCELLATION_DISTRIBUTED,
    CANCELLATION_FAILED, CANCELLATION_ACCEPTED, CANCELLATION_COMPLETED
  }
